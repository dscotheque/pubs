...
def _make_mock_work(
    ...
    """Create a mock Work object with model_dump support."""
    work = MagicMock()
    work.doi = doi
...
def test_list_works_with_researcher_filter(
    ...
    """Verify researcher query param is forwarded to engine."""
...
def test_list_works_with_year_filter(
    ...
    """Verify year query param is forwarded to engine."""
    mock_engine.get_works.return_value = []
...
def test_list_works_with_funder_filter(
    ...
    """Verify funder filter routes to get_works_by_funder."""
...
def test_search_works_requires_query(client: TestClient) -> None:
    """Verify GET /works/search returns 422 without q param."""
